...
export const FullScreenScrollFX = forwardRef<any, FullScreenFXProps>(
    (
        {
            sections,
            className,
        ...
        return (
          ...
          .fx-content {
            ...
            display: grid; grid-template-columns: minmax(100px, 1fr) 4fr minmax(100px, 1fr);
            align-items: center;
            height: 100%;
            padding: 0 var(--fx-grid-px);
          }
          ...
          .fx-center {
            display: grid; place-items: center; text-align: center; height: 60vh; overflow: visible; z-index: 10;
            position: relative;
          }
          .fx-featured { position: absolute; opacity: 0; visibility: hidden; width: 100%; display: flex; justify-content: center; transition: opacity 0.8s ease, visibility 0.8s; }
          .fx-featured.active { opacity: 1; visibility: visible; }
          .fx-featured-content { width: 100%; }
          .fx-featured-title {
          ...
          @media (max-width: 900px) {
            ...
            .fx-center { height: auto; position: relative; }
            .fx-featured { position: relative; opacity: 1; visibility: visible; display: none; }
            .fx-featured.active { display: block; }
          }
        `}</style>
            </div >
        );
