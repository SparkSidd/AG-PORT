...
const CARDS: CardDef[] = [
  ...
  { x: 2160, y: 300, w: 380, h: 200, kind: "chart", hue: 100, label: "Latency" },
  ...
  { x: 1320, y: 740, w: 360, h: 220, kind: "counter", hue: 140, label: "Active" },
  ...
  { x: 1400, y: 1000, w: 280, h: 220, kind: "counter", hue: 360, label: "Jobs" },
  ...
  { x: 1740, y: 1280, w: 360, h: 260, kind: "counter", hue: 300, label: "Bytes" },
  ...
  { x: 1740, y: 1620, w: 380, h: 220, kind: "counter", hue: 100, label: "Hooks" },
  ...
  { x: 1420, y: 1880, w: 480, h: 240, kind: "chart", hue: 260, label: "Tokens" },
  { x: 1940, y: 1880, w: 280, h: 240, kind: "counter", hue: 20, label: "Calls" },
...
function Card({
  ...
  // Mix emerald hues into accent for theme cohesion
  const emeraldAccent = `hsl(${(card.hue + 155) % 360}, 70%, 60%)`;
  const themedAccent = index % 3 === 0 ? accent : index % 3 === 1 ? emeraldAccent : accent;
  const baseStyle: React.CSSProperties = {
    ...
    height: card.h,
    borderRadius: 18,
    background: "linear-gradient(180deg, #0d1f15 0%, #090f0c 100%)",
  ...
  if (card.kind === "chart") {
    return (
      <div style={baseStyle}>
        {labelEl}
        <div style={{ flex: 1 }}>
          <ChartCard accent={themedAccent} t={t} />
        </div>
      </div>
    );
  }
  if (card.kind === "bars") {
    return (
      <div style={baseStyle}>
        {labelEl}
        <div style={{ flex: 1 }}>
          <BarsCard accent={themedAccent} t={t} />
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ ...baseStyle, padding: 0 }}>
      <GradientCard hue={(card.hue + 145) % 360} />
    </div>
  );
}
