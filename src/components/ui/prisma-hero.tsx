...
export const PrismaVideoBackground = () => {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none bg-black">
      <video
        ...
        muted
        playsInline
        className="absolute inset-0 h-full w-full object-cover opacity-40 grayscale sepia-[.2] hue-rotate-[70deg]"
        src="https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260405_170732_8a9ccda6-5cff-4628-b164-059c500a2b41.mp4"
      />
      
      {/* Emerald tint to match the portfolio theme */}
      <div className="absolute inset-0 bg-emerald-900/30 mix-blend-color" />
      
      {/* Tech grid overlay to blend the video with the UI */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#22c55e0a_1px,transparent_1px),linear-gradient(to_bottom,#22c55e0a_1px,transparent_1px)] bg-[size:24px_24px]" />
      
      <div className="noise-overlay pointer-events-none absolute inset-0 opacity-[0.5] mix-blend-overlay" />
      
      {/* Heavy vignette for text readability in the center and edges */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,black_100%)] opacity-80" />
